...
var _annotations = _interopRequireDefault(require("../request_processors/annotations"));
...
function buildAnnotationRequest(...args) {
  const processor = (0, _build_processor_function.default)(_annotations.default, ...args);
  const doc = processor({});
  return doc;
}