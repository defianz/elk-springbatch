...
var _series = _interopRequireDefault(require("../response_processors/series"));
...
function handleResponseBody(panel) {
  return resp => {
    ...
    const processor = (0, _build_processor_function.default)(_series.default, resp, panel, series, meta);
    return processor([]);
  };
}
