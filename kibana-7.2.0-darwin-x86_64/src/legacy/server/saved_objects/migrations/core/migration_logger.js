...
class MigrationLogger {
  constructor(log) {
    ...
    _defineProperty(this, "info", msg => this.log(['info', 'migrations'], msg));

    _defineProperty(this, "debug", msg => this.log(['debug', 'migrations'], msg));

    _defineProperty(this, "warning", msg => this.log(['warning', 'migrations'], msg));
