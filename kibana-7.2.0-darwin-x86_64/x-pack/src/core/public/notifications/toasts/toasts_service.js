...
class ToastsService {
    setup() {
        this.api = new toasts_api_1.ToastsApi();
        return this.api;
    }
    start({ i18n, targetDomElement }) {
        this.targetDomElement = targetDomElement;
        react_dom_1.render(react_1.default.createElement(i18n.Context, null,
            react_1.default.createElement(global_toast_list_1.GlobalToastList, { dismissToast: (toast) => this.api.remove(toast), "toasts$": this.api.get$() })), targetDomElement);
        return this.api;
    }
    stop() {
