...
class FlyoutService {
    constructor(targetDomElement) {
         ...
         */
        this.openFlyout = (i18n, flyoutChildren, flyoutProps = {}) => {
            ...
            react_dom_1.render(react_1.default.createElement(i18n.Context, null,
                react_1.default.createElement(eui_1.EuiFlyout, Object.assign({}, flyoutProps, { onClose: () => flyout.close() }), flyoutChildren)), this.targetDomElement);
            return flyout;
        };
    }
    /**
