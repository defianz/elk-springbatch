...
class ModalService {
    constructor(targetDomElement) {
         ...
         */
        this.openModal = (i18n, modalChildren, modalProps = {}) => {
            ...
            react_dom_1.render(react_1.default.createElement(eui_1.EuiOverlayMask, null,
                react_1.default.createElement(i18n.Context, null,
                    react_1.default.createElement(eui_1.EuiModal, Object.assign({}, modalProps, { onClose: () => modal.close() }), modalChildren))), this.targetDomElement);
            return modal;
        };
    }
    /**
