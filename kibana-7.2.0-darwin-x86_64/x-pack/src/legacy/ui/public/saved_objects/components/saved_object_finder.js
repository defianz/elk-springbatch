...
const FixedEuiListGroup = eui_1.EuiListGroup;
...
const FixedEuiContextMenuPanel = eui_1.EuiContextMenuPanel;
class SavedObjectFinder extends react_1.default.Component {
    constructor(props) {
        super(props);
        this.isComponentMounted = false;
        this.debouncedFetch = lodash_1.default.debounce(async (query) => {
            const metaDataMap = this.getSavedObjectMetaDataMap();
            const resp = await chrome_1.default.getSavedObjectsClient().find({
                type: Object.keys(metaDataMap),
                fields: ['title', 'visState'],
                search: query ? `${query}*` : undefined,
                page: 1,
                perPage: chrome_1.default.getUiSettingsClient().get('savedObjects:listingLimit'),
    ...
    getSortOptions() {
        const sortOptions = [
            react_1.default.createElement(eui_1.EuiContextMenuItem, { key: "asc", icon: this.state.sortDirection === 'asc' ||
                ...
                } }, i18n_1.i18n.translate('common.ui.savedObjects.finder.sortAsc', {
            ...
            react_1.default.createElement(eui_1.EuiContextMenuItem, { key: "desc", icon: this.state.sortDirection === 'desc' ? 'check' : 'empty', onClick: () => {
                ...
                } }, i18n_1.i18n.translate('common.ui.savedObjects.finder.sortDesc', {
        ...
        if (this.state.query) {
            sortOptions.push(react_1.default.createElement(eui_1.EuiContextMenuItem, { key: "auto", icon: !this.state.sortDirection ? 'check' : 'empty', onClick: () => {
                ...
                } }, i18n_1.i18n.translate('common.ui.savedObjects.finder.sortAuto', {
    ...
    renderSearchBar() {
        ...
        return (react_1.default.createElement(eui_1.EuiFlexGroup, { gutterSize: "m" },
            react_1.default.createElement(eui_1.EuiFlexItem, { grow: true },
                react_1.default.createElement(eui_1.EuiFieldSearch, { placeholder: i18n_1.i18n.translate('common.ui.savedObjects.finder.searchPlaceholder', {
            ...
            react_1.default.createElement(eui_1.EuiFlexItem, { grow: false },
                react_1.default.createElement(eui_1.EuiFilterGroup, null,
                    react_1.default.createElement(eui_1.EuiPopover, { id: "addPanelSortPopover", panelClassName: "euiFilterGroup__popoverPanel", panelPaddingSize: "none", isOpen: this.state.sortOpen, closePopover: () => this.setState({ sortOpen: false }), button: react_1.default.createElement(eui_1.EuiFilterButton, { onClick: () => this.setState(({ sortOpen }) => ({
                                sortOpen: !sortOpen,
                            })), iconType: "arrowDown", isSelected: this.state.sortOpen, "data-test-subj": "savedObjectFinderSortButton" }, i18n_1.i18n.translate('common.ui.savedObjects.finder.sortButtonLabel', {
                            defaultMessage: 'Sort',
                        })) },
                        react_1.default.createElement(FixedEuiContextMenuPanel, { watchedItemProps: ['icon', 'disabled'], items: this.getSortOptions() })),
    ...
    renderListing() {
        ...
        return (react_1.default.createElement(react_1.default.Fragment, null,
            ...
            items.length > 0 ? (react_1.default.createElement(FixedEuiListGroup, { "data-test-subj": "savedObjectFinderItemList", maxWidth: false }, items.map(item => {
