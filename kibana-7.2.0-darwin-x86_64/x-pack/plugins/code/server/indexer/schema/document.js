...
exports.DocumentAnalysisSettings = {
    analysis: {
        analyzer: {
            content_analyzer: {
                tokenizer: 'standard',
...
exports.DocumentIndexNamePrefix = `.code-document`;
exports.DocumentIndexName = (repoUri) => {
    return `${exports.DocumentIndexNamePrefix}-${repository_utils_1.RepositoryUtils.normalizeRepoUriToIndexName(repoUri)}`;
};
exports.DocumentSearchIndexWithScope = (repoScope) => {
    return repoScope.map((repoUri) => `${exports.DocumentIndexName(repoUri)}*`).join(',');
};
