...
const with_internal_request_1 = require("./with_internal_request");
class EsClientWithInternalRequest extends with_internal_request_1.WithInternalRequest {
    constructor(server) {
        super(server);
...
exports.EsClientWithInternalRequest = EsClientWithInternalRequest;
