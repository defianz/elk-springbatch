...
| progress shape="horizontalBar" label={formatnumber 0%} font={font size=24 family="${fonts_1.openSans.value}" color="#000000" align=center}
| render`,
});
