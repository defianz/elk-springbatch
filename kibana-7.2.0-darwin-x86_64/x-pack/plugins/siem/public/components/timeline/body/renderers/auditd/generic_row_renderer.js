...
exports.createGenericAuditRowRenderer = ({ actionName, text, }) => ({
    isInstance: ecs => {
    ...
    renderRow: ({ browserFields, data, width, children }) => (react_1.default.createElement(helpers_1.Row, null,
        ...
        react_1.default.createElement(row_renderer_1.RowRendererContainer, { width: width },
            react_1.default.createElement(generic_details_1.AuditdGenericDetails, { browserFields: browserFields, data: data, contextId: actionName, text: text })))),
});
exports.createGenericFileRowRenderer = ({ actionName, text, fileIcon = 'document', }) => ({
    isInstance: ecs => {
        const module = fp_1.get('event.module[0]', ecs);
        const action = fp_1.get('event.action[0]', ecs);
        return (module != null &&
    ...
    renderRow: ({ browserFields, data, width, children }) => (react_1.default.createElement(helpers_1.Row, null,
        children,
        react_1.default.createElement(row_renderer_1.RowRendererContainer, { width: width },
            react_1.default.createElement(generic_file_details_1.AuditdGenericFileDetails, { browserFields: browserFields, data: data, contextId: actionName, text: text, fileIcon: fileIcon })))),
});
...
const auditdWasAuthorizedRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'was-authorized',
    text: i18n.WAS_AUTHORIZED_TO_USE,
});
const auditdStartedSessionRowRenderer = exports.createGenericAuditRowRenderer({
...
const auditdLoggedInDeprecatedRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'logged-in',
    text: i18n.ATTEMPTED_LOGIN,
});
const auditdLoggedInRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'login',
    text: i18n.ATTEMPTED_LOGIN,
});
const auditdExecutedRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'executed',
    text: i18n.EXECUTED,
});
const auditdEndedFromRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'ended-session',
    text: i18n.ENDED_FROM,
});
const auditdAcquiredCredentialsRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'acquired-credentials',
    text: i18n.ACQUIRED_CREDENTIALS_TO,
});
const auditdDisposedCredentialsRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'disposed-credentials',
    text: i18n.DISPOSED_CREDENTIALS_TO,
});
const auditdConnectedToRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'connected-to',
    text: i18n.CONNECTED_USING,
});
const auditdOpenedFileRowRenderer = exports.createGenericFileRowRenderer({
    actionName: 'opened-file',
    text: i18n.OPENED_FILE,
});
// This doesn't produce a file.path so I use the generic row renderer
const auditdChangedFileAttributeOfRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'changed-file-attributes-of',
    text: i18n.CHANGED_FILE_ATTRIBUTES_OF,
});
const auditdChangedFilePermissionsOfRowRenderer = exports.createGenericFileRowRenderer({
    actionName: 'changed-file-permissions-of',
    text: i18n.CHANGED_FILE_PERMISSIONS_OF,
});
const auditdChangedFileOwnershipOfRowRenderer = exports.createGenericFileRowRenderer({
    actionName: 'changed-file-ownership-of',
    text: i18n.CHANGED_FILE_OWNERSHIP_OF,
});
// TODO: Not UI-tested
const auditdChangedKernelModuleRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'loaded-kernel-module',
    text: i18n.LOADED_KERNEL_MODULE,
});
// TODO: Not UI-tested
const auditdUnloadedKernelModuleRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'unloaded-kernel-module',
    text: i18n.UNLOADED_KERNEL_MODULE_OF,
});
const auditdCreatedDirectoryRowRenderer = exports.createGenericFileRowRenderer({
    actionName: 'created-directory',
    text: i18n.CREATED_DIRECTORY,
    fileIcon: 'folderOpen',
});
const auditdMountedRowRenderer = exports.createGenericFileRowRenderer({
    actionName: 'mounted',
    text: i18n.MOUNTED,
});
const auditdRenamedRowRenderer = exports.createGenericFileRowRenderer({
    actionName: 'renamed',
    text: i18n.RENAMED,
});
const auditdCheckedMetaDataRowRenderer = exports.createGenericFileRowRenderer({
    actionName: 'checked-metadata-of',
    text: i18n.CHECKED_METADATA_OF,
});
const auditdCheckedFileSystemMetaDataRowRenderer = exports.createGenericFileRowRenderer({
    actionName: 'checked-filesystem-metadata-of',
    text: i18n.CHECKED_FILE_SYSTEM_METADATA_OF,
});
const auditdSymLinkedDataRowRenderer = exports.createGenericFileRowRenderer({
    actionName: 'symlinked',
    text: i18n.SYMLINKED,
});
// TODO: UI-Testing
const auditdUnmountedRowRenderer = exports.createGenericFileRowRenderer({
    actionName: 'unmounted',
    text: i18n.UNMOUNTED,
});
const auditdDeletedRowRenderer = exports.createGenericFileRowRenderer({
    actionName: 'deleted',
    text: i18n.DELETED,
});
const auditdChangedTimeStampOfRowRenderer = exports.createGenericFileRowRenderer({
    actionName: 'changed-timestamp-of',
    text: i18n.CHANGED_TIME_STAMP_OF,
});
// TODO: UI-Testing
const auditdListenForConnectionsRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'listen-for-connections',
    text: i18n.LISTEN_FOR_CONNECTIONS,
});
const auditdBoundSocketRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'bound-socket',
    text: i18n.BOUND_SOCKET_FROM,
});
const auditdReceivedFromRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'received-from',
    text: i18n.RECEIVED_FROM,
});
const auditdSentToRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'sent-to',
    text: i18n.SENT_TO,
});
const auditdKilledPidRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'killed-pid',
    text: i18n.KILLED_PROCESS_ID_OF,
});
const auditdChangedIdentityRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'changed-identity-of',
    text: i18n.CHANGED_IDENTITY_USING,
});
// TODO: UI-Testing
const auditdChangedSystemTimeRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'changed-system-time',
    text: i18n.CHANGED_SYSTEM_TIME_WITH,
});
// TODO: UI-Testing
const auditdMakeDeviceRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'make-device',
    text: i18n.MADE_DEVICE_WITH,
});
// TODO: UI-Testing
const auditdChangedSystemNameRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'changed-system-name',
    text: i18n.CHANGED_SYSTEM_NAME,
});
const auditdAllocatedMemoryRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'allocated-memory',
    text: i18n.ALLOCATED_MEMORY_FOR,
});
// TODO: UI-Testing
const auditdSchedulingPolicyRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'adjusted-scheduling-policy-of',
    text: i18n.SCHEDULED_POLICY_OF,
});
const auditdAddedUserAccountRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'added-user-account',
    text: i18n.ADDED_USER_ACCOUNT,
});
// TODO: UI-Testing
const auditdCausedMacPolicyErrorRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'caused-mac-policy-error',
    text: i18n.CAUSED_MAC_POLICY_ERROR,
});
// TODO: UI-Testing
const auditdloadedFirewallRuleErrorRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'loaded-firewall-rule-to',
    text: i18n.LOADED_FIREWALL_RULE,
});
const auditdChangedPromiscuousModeRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'changed-promiscuous-mode-on-device',
    text: i18n.CHANGED_PROMISCUOUS_MODE,
});
// TODO: UI-Testing
const auditdLockedAccountModeRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'locked-account',
    text: i18n.LOCKED_ACCOUNT,
});
// TODO: UI-Testing
const auditdUnLockedAccountModeRowRenderer = exports.createGenericAuditRowRenderer({
...
const auditdAddedGroupAccountModeRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'added-group-account-to',
    text: i18n.ADDED_GROUP_ACCOUNT_USING,
});
// TODO: UI-Testing
const auditdCrashedProgramRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'crashed-program',
    text: i18n.CRASHED_PROGRAM,
});
// TODO: UI-Testing
const auditdAttemptedExecutionOfForbiddenProgramRowRenderer = exports.createGenericAuditRowRenderer({
...
const auditdSuspiciousLinkDeprecatedRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'used-suspcious-link',
    text: i18n.USED_SUSPICIOUS_PROGRAM,
});
// TODO: UI-Testing
const auditdSuspiciousLinkRowRenderer = exports.createGenericAuditRowRenderer({
...
const auditdFailedLoginDeprecatedTooManyTimesRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'failed-log-in-too-many-times-to',
    text: i18n.FAILED_LOGIN_TOO_MANY_TIMES,
});
const auditdFailedLoginTooManyTimesRowRenderer = exports.createGenericAuditRowRenderer({
...
// NOTE: Remove this once this ticket is solved: https://github.com/elastic/go-libaudit/issues/52
// This has to remain for forwards and backwards compatibility until customers no longer have this string
const auditdLoginFromUnusualDeprecatedPlaceToRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'attempted-log-in-from-unusual-place-to',
    text: i18n.ATTEMPTED_LOGIN_FROM_UNUSUAL_PLACE,
});
// TODO: UI-Testing
const auditdLoginFromUnusualPlaceToRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'attempted-login-from-unusual-place-to',
    text: i18n.ATTEMPTED_LOGIN_FROM_UNUSUAL_PLACE,
});
// TODO: UI-Testing
const auditdOpenTooManySessionsToRowRenderer = exports.createGenericAuditRowRenderer({
...
// NOTE: Remove this once this ticket is solved: https://github.com/elastic/go-libaudit/issues/52
// This has to remain for forwards and backwards compatibility until customers no longer have this string
const auditdLoginFromDeprecatedUnusualHourRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'attempted-log-in-during-unusual-hour-to',
    text: i18n.ATTEMPTED_LOGIN_FROM_UNUSUAL_HOUR,
});
// TODO: UI-Testing
const auditdLoginFromUnusualHourRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'attempted-login-during-unusual-hour-to',
    text: i18n.ATTEMPTED_LOGIN_FROM_UNUSUAL_HOUR,
});
// TODO: UI-Testing
const auditdTestedFileSystemIntegoryOfRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'tested-file-system-integrity-of',
    text: i18n.TESTED_FILE_SYSTEM_INTEGRITY,
});
// TODO: UI-Testing
const auditdViolatedSelinuxPolicyRowRenderer = exports.createGenericAuditRowRenderer({
...
const auditdViolatedAppArmorPolicyRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'violated-apparmor-policy',
    text: i18n.VIOLATED_APP_ARMOR_POLICY_FROM,
});
// TODO: UI-Testing
const auditdChangedGropuRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'changed-group',
    text: i18n.CHANGED_GROUP,
});
// TODO: UI-Testing
const auditdChangedUserIdRowRenderer = exports.createGenericAuditRowRenderer({
...
const auditdChangedAuditConfigurationDeprecatedRowRenderer = exports.createGenericAuditRowRenderer({
...
const auditdChangedAuditConfigurationRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'changed-audit-configuration',
    text: i18n.CHANGED_AUDIT_CONFIGURATION,
});
const auditdRefreshedCredentialsRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'refreshed-credentials',
    text: i18n.REFRESHED_CREDENTIALS_FOR,
});
// TODO: UI-Testing
const auditdNegotiatedCryptoKeyRowRenderer = exports.createGenericAuditRowRenderer({
...
// NOTE: Remove this once this ticket is solved: https://github.com/elastic/go-libaudit/issues/52
// This has to remain for forwards and backwards compatibility until customers no longer have this string
const auditdCryptoOfficerLoggednDeprecatedRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'crypto-officer-logged-in',
    text: i18n.CRYPTO_OFFICER_LOGGED_IN,
});
const auditdCryptoOfficerLoggednRowRenderer = exports.createGenericAuditRowRenderer({
...
// NOTE: Remove this once this ticket is solved: https://github.com/elastic/go-libaudit/issues/52
// This has to remain for forwards and backwards compatibility until customers no longer have this string
const auditdCryptoOfficerLoggedoutDeprecatedRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'crypto-officer-logged-out',
    text: i18n.CRYPTO_OFFICER_LOGGED_OUT,
});
// TODO: UI-Testing
const auditdCryptoOfficerLoggedoutRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'crypto-officer-logout',
    text: i18n.CRYPTO_OFFICER_LOGGED_OUT,
});
// TODO: UI-Testing
const auditdStartedCryptoSessionRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'started-crypto-session',
    text: i18n.STARTED_CRYPTO_SESSION,
});
// TODO: UI-Testing
const auditdAccessResultRowRenderer = exports.createGenericAuditRowRenderer({
...
// This has to remain for forwards and backwards compatibility until customers no longer have this string
const auditdAbortedAuditDeprecatedStartupRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'aborted-auditd-startup',
    text: i18n.ABORTED_AUDIT_STARTUP,
});
// TODO: UI-Testing
const auditdAbortedAuditStartupRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'aborted-audit-startup',
    text: i18n.ABORTED_AUDIT_STARTUP,
});
// TODO: UI-Testing
const auditdRemoteAuditConnectedRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'remote-audit-connected',
    text: i18n.REMOTE_AUDIT_CONNECTED,
});
// TODO: UI-Testing
const auditdRemoteAuditDisconnectedRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'remote-audit-disconnected',
    text: i18n.REMOTE_AUDIT_DISCONNECTED,
});
// TODO: UI-Testing
const auditdShutdownAuditRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'shutdown-audit',
    text: i18n.SHUTDOWN_AUDIT,
});
// TODO: UI-Testing
const auditdAuditErrorRowRenderer = exports.createGenericAuditRowRenderer({
...
const auditdReconfiguredAuditDeprecatedRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'reconfigured-auditd',
    text: i18n.RECONFIGURED_AUDIT,
});
// TODO: UI-Testing
const auditdReconfiguredAuditRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'reconfigured-audit',
    text: i18n.RECONFIGURED_AUDIT,
});
// TODO: UI-Testing
const auditdResumedAuditLoggingRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'resumed-audit-logging',
    text: i18n.RESUMED_AUDIT_LOGGING,
});
// TODO: UI-Testing
const auditdRotatedAuditLogsRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'rotated-audit-logs',
    text: i18n.ROTATED_AUDIT_LOGS,
});
// TODO: UI-Testing
const auditdStartedAuditRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'started-audit',
    text: i18n.STARTED_AUDIT,
});
const auditdDeletedGroupAccountFromRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'deleted-group-account-from',
    text: i18n.DELETED_GROUP_ACCOUNT_USING,
});
const auditdDeletedUserAccountRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'deleted-user-account',
    text: i18n.DELETED_USER_ACCOUNT_USING,
});
// TODO: UI-Testing
const auditdChangedAuditFeatureRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'changed-audit-feature',
    text: i18n.CHANGED_AUDIT_FEATURE,
});
// TODO: UI-Testing
const auditdRelabeledRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'relabeled-filesystem',
    text: i18n.RELABELED_FILESYSTEM,
});
// TODO: UI-Testing
const auditdAuthenticatedToGroupRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'authenticated-to-group',
    text: i18n.AUTHENTICATED_TO_GROUP,
});
// TODO: UI-Testing
const auditdChangedGroupPasswordRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'changed-group-password',
    text: i18n.CHANGED_GROUP_PASSWORD,
});
// TODO: UI-Testing
const auditdModifiedGroupAccountRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'modified-group-account',
    text: i18n.MODIFIED_GROUP_ACCOUNT,
});
// TODO: UI-Testing
const auditdInitializedAuditSubsystemRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'initialized-audit-subsystem',
    text: i18n.INITIALIZED_AUDIT_SUBSYSTEM,
});
// TODO: UI-Testing
const auditdModifiedLevelOfRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'modified-level-of',
    text: i18n.MODIFIED_LEVEL_OF,
});
// TODO: UI-Testing
const auditdOverrodeLabelOfRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'overrode-label-of',
    text: i18n.OVERRODE_LABEL_OF,
});
// TODO: UI-Testing
const auditdChangedLoginIdToRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'changed-login-id-to',
    text: i18n.CHANGED_LOGIN_ID_TO,
});
// TODO: UI-Testing
const auditdMacPermissionRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'mac-permission',
    text: i18n.MAC_PERMISSION,
});
// TODO: UI-Testing
const auditdChangedSelinuxBooleanRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'changed-selinux-boolean',
    text: i18n.CHANGED_SELINUX_BOOLEAN,
});
// TODO: UI-Testing
const auditdLoadedSelinuxPolicyRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'loaded-selinux-policy',
    text: i18n.LOADED_SELINUX_POLICY,
});
// TODO: UI-Testing
const auditdChangedSelinuxEnforcementRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'changed-selinux-enforcement',
    text: i18n.CHANGED_SELINUX_ENFORCEMENT,
});
// TODO: UI-Testing
const auditdAssignedUserRoleToRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'assigned-user-role-to',
    text: i18n.ASSIGNED_USER_ROLE_TO,
});
// TODO: UI-Testing
const auditdModifiedRoleRowRenderer = exports.createGenericAuditRowRenderer({
...
const auditdRemovedUserRoleDeprecatedFromRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'removed-use-role-from',
    text: i18n.REMOVED_USER_ROLE_FROM,
});
// TODO: UI-Testing
const auditdRemovedUserRoleFromRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'removed-user-role-from',
    text: i18n.REMOVED_USER_ROLE_FROM,
});
// TODO: UI-Testing
const auditdViolatedSeccompPolicyRowRenderer = exports.createGenericAuditRowRenderer({
...
const auditdStartedServiceRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'started-service',
    text: i18n.STARTED_SERVICE,
});
// TODO: How do you get the service name? auditd.summary.object.primary kind of gives it sometimes
// TODO: Investigate a custom renderer for this at some point (or have it be more ECS compliant)
const auditdStoppedServiceRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'stopped-service',
    text: i18n.STOPPED_SERVICE,
});
// TODO: UI-Testing
const auditdBootedSystemRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'booted-system',
    text: i18n.BOOTED_SYSTEM,
});
const auditdChangedToRunlevelRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'changed-to-runlevel',
    text: i18n.CHANGED_TO_RUN_LEVEL_WITH,
});
// TODO: UI-Testing
const auditdShutdownSystemRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'shutdown-system',
    text: i18n.SHUTDOWN_SYSTEM,
});
// TODO: UI-Testing
const auditdSentTestRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'sent-test',
    text: i18n.SENT_TEST,
});
// TODO: UI-Testing
const auditdUnknownRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'unknown',
    text: i18n.UNKNOWN,
});
// TODO: UI-Testing
const auditdSentMessageRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'sent-message',
    text: i18n.SENT_MESSAGE,
});
// TODO: UI-Testing
const auditdAccessPermissionRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'access-permission',
    text: i18n.ACCESS_PERMISSION,
});
const auditdAuthenticated = exports.createGenericAuditRowRenderer({
    actionName: 'authenticated',
    text: i18n.AUTHENTICATED_USING,
});
const auditdChangedPasswordRowRenderer = exports.createGenericAuditRowRenderer({
...
const auditdRanCommandRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'ran-command',
    text: i18n.RAN_COMMAND,
});
const auditdErrorRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'error',
    text: i18n.ERROR_FROM,
});
// TODO: UI-Testing
// NOTE: Remove this once this ticket is solved: https://github.com/elastic/go-libaudit/issues/52
const auditdLoggedOutDeprecatedRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'logged-out',
    text: i18n.LOGGED_OUT,
});
// TODO: UI-Testing
const auditdLoggedOutRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'logout',
    text: i18n.LOGGED_OUT,
});
// TODO: UI-Testing
const auditdChangedMacConfigurationRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'changed-mac-configuration',
    text: i18n.CHANGED_MAC_CONFIGURATION,
});
// TODO: UI-Testing
const auditdLoadedMacPolicyRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'loaded-mac-policy',
    text: i18n.LOADED_MAC_POLICY,
});
// TODO: UI-Testing
const auditdModifiedUserAccountRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'modified-user-account',
    text: i18n.MODIFIED_USER_ACCOUNT,
});
const auditdChangedRoleToRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'changed-role-to',
    text: i18n.CHANGED_ROLE_USING,
});
// TODO: UI-Testing
const auditdAccessErrorRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'access-error',
    text: i18n.ACCESS_ERROR,
});
const auditdChangedConfigurationRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'changed-configuration',
    text: i18n.CHANGED_CONFIGURATION_WITH,
});
// TODO: UI-Testing
const auditdIssuedVmControlRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'issued-vm-control',
    text: i18n.ISSUED_VM_CONTROL,
});
// TODO: UI-Testing
const auditdCreatedVmImageRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'created-vm-image',
    text: i18n.CREATED_VM_IMAGE,
});
// TODO: UI-Testing
const auditdDeletedVmImageRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'deleted-vm-image',
    text: i18n.DELETED_VM_IMAGE,
});
// TODO: UI-Testing
const auditdCheckedIntegrityOfRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'checked-integrity-of',
    text: i18n.CHECKED_INTEGRITY_OF,
});
// TODO: UI-Testing
const auditdAssignedVmIdRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'assigned-vm-id',
    text: i18n.ASSIGNED_VM_ID,
});
// TODO: UI-Testing
const auditdMigratedVmFromRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'migrated-vm-from',
    text: i18n.MIGRATED_VM_FROM,
});
// TODO: UI-Testing
const auditdMigratedVmToRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'migrated-vm-to',
    text: i18n.MIGRATED_VM_TO,
});
// TODO: UI-Testing
const auditdAssignedVmResourceRowRenderer = exports.createGenericAuditRowRenderer({
    actionName: 'assigned-vm-resource',
    text: i18n.ASSIGNED_VM_RESOURCE,
});
exports.auditdRowRenderers = [
