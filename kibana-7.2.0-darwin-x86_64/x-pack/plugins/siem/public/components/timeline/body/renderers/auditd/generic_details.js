...
exports.AuditdGenericLine = recompose_1.pure(({ id, contextId, hostName, userName, primary, processName, processPid, processExecutable, processTitle, secondary, workingDirectory, args, result, session, text, }) => (React.createElement(eui_1.EuiFlexGroup, { justifyContent: "center", gutterSize: "none", wrap: true },
    ...
    processExecutable != null && (React.createElement(helpers_1.TokensFlexItem, { grow: false, component: "span" }, text)),
...
exports.AuditdGenericDetails = recompose_1.pure(({ data, contextId, text }) => {
    const id = data._id;
    ...
    if (data.process != null) {
        return (React.createElement(helpers_1.Details, null,
            React.createElement(exports.AuditdGenericLine, { id: id, contextId: contextId, text: text, hostName: hostName, userName: userName, processName: processName, processPid: processPid, processExecutable: processExecutable, processTitle: processTitle, workingDirectory: workingDirectory, args: args, session: session, primary: primary, result: result, secondary: secondary }),
