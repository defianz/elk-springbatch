...
class AutoSizer extends react_1.default.PureComponent {
    constructor(props) {
        ...
        this.measure = (entry) => {
            ...
            const { boundsMeasurement: previousBoundsMeasurement, contentMeasurement: previousContentMeasurement, windowMeasurement: previousWindowMeasurement, } = this.state;
            ...
            if (isEqual_1.default(boundsMeasurement, previousBoundsMeasurement) &&
                ...
                isEqual_1.default(windowMeasurement, previousWindowMeasurement)) {
                return;
            }
