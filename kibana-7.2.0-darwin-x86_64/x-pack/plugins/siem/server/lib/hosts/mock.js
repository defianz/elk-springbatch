...
exports.mockGetHostsOptions = {
    ...
    sort: { field: types_1.HostsFields.lastSeen, direction: types_1.Direction.asc },
...
exports.mockGetHostOverviewOptions = {
    sourceConfiguration: {
        fields: {
            container: 'docker.container.name',
            host: 'beat.hostname',
...
exports.mockGetHostOverviewRequest = {
    params: {},
    payload: {
...
exports.mockGetHostOverviewResponse = {
    took: 2205,
    timed_out: false,
...
exports.mockGetHostOverviewResult = {
    _id: 'siem-es',
    host: {
        architecture: 'x86_64',
...
exports.mockGetHostLastFirstSeenOptions = {
    defaultIndex: ['auditbeat-*', 'filebeat-*', 'packetbeat-*', 'winlogbeat-*'],
    sourceConfiguration: {
        fields: {
            container: 'docker.container.name',
...
exports.mockGetHostLastFirstSeenRequest = {
    params: {},
    payload: {
...
exports.mockGetHostLastFirstSeenResponse = {
    took: 60,
    timed_out: false,
    _shards: {
        total: 59,
