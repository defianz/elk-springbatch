...
exports.mockDomainsResponseBuckets = [
    {
        key: 'example.com',
        uniqueIpCount: {
            value: 805,
        ...
        direction: {
            buckets: [
                {
                    key: types_1.NetworkDirectionEcs.outbound,
                    doc_count: 51668,
                },
                {
                    key: types_1.NetworkDirectionEcs.inbound,
                    doc_count: 25681,
                },
            ],
        },
...
exports.mockFormattedSource = [
    {
        ...
        node: {
            ...
            network: {
                bytes: 974964465,
                direction: [types_1.NetworkDirectionEcs.outbound, types_1.NetworkDirectionEcs.inbound],
                packets: 16946245,
            },
            source: {
...
exports.mockFormattedDestination = [
    {
        cursor: { tiebreaker: null, value: 'example.com' },
        node: {
            _id: 'example.com',
...
exports.mockFormattedUsersEdges = [
    {
        node: {
            _id: '_apt',
            user: {
