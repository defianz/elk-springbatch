                ...
                fields: [
                    {
                        name: 'transaction_id',
                        type: 'keyword',
                        description: 'Transaction ID, a random number chosen by the client, used by the client and server to associate messages and responses between a client and a server.',
                    },
                    {
                        name: 'seconds',
                        type: 'long',
                        description: 'Number of seconds elapsed since client began address acquisition or renewal process.',
                    },
                    {
                        name: 'flags',
                        type: 'keyword',
                        description: 'Flags are set by the client to indicate how the DHCP server should its reply -- either unicast or broadcast.',
                    },
                    {
                        name: 'client_ip',
                        type: 'ip',
                    ...
                    },
                    {
                        name: 'assigned_ip',
                        type: 'ip',
                        description: 'The IP address that the DHCP server is assigning to the client. This field is also known as "your" IP address.',
                    },
                    {
                        name: 'server_ip',
                        type: 'ip',
                    ...
                    },
                    {
                        name: 'relay_ip',
                        type: 'ip',
                        description: 'The relay IP address used by the client to contact the server (i.e. a DHCP relay server).',
                    },
                    {
                        name: 'client_mac',
                        type: 'keyword',
                    ...
                    },
                    {
                        name: 'server_name',
                        type: 'keyword',
                        description: 'The name of the server sending the message. Optional. Used in DHCPOFFER or DHCPACK messages.',
                    },
                    {
                        name: 'op_code',
                        type: 'keyword',
                        ...
                        fields: [
                            {
                                ...
                                type: 'keyword',
                                example: 'ack',
                                description: 'The specific type of DHCP message being sent (e.g. discover, offer, request, decline, ack, nak, release, inform).',
                            },
                            {
                                name: 'parameter_request_list',
                                type: 'keyword',
                                description: 'This option is used by a DHCP client to request values for specified configuration parameters.',
                            },
                            {
                            ...
                            },
                            {
                                ...
                                type: 'ip',
                                description: "This option specifies the broadcast address in use on the client's subnet. ",
                            },
                            {
                                name: 'max_dhcp_message_size',
                                type: 'long',
                                description: 'This option specifies the maximum length DHCP message that the client is willing to accept.',
                            },
                            {
                                name: 'class_identifier',
                                type: 'keyword',
                                description: "This option is used by DHCP clients to optionally identify the vendor type and configuration of a DHCP client. Vendors may choose to define specific vendor class identifiers to convey particular configuration or other identification information about a client.  For example, the identifier may encode the client's hardware configuration. ",
                            },
                            {
                                name: 'domain_name',
                                type: 'keyword',
                            ...
                            },
                            {
                                name: 'dns_servers',
                                type: 'ip',
                                description: 'The domain name server option specifies a list of Domain Name System servers available to the client.',
                            },
                            {
                                name: 'vendor_identifying_options',
                                type: 'object',
                                description: 'A DHCP client may use this option to unambiguously identify the vendor that manufactured the hardware on which the client is running, the software in use, or an industry consortium to which the vendor belongs. This field is described in RFC 3925.',
                            },
                            {
                                name: 'subnet_mask',
                                type: 'ip',
                            ...
                            },
                            {
                                ...
                                type: 'long',
                                description: "The time offset field specifies the offset of the client's subnet in seconds from Coordinated Universal Time (UTC). ",
                            },
                            {
                                name: 'router',
                                type: 'ip',
                                description: "The router option specifies a list of IP addresses for routers on the client's subnet. ",
                            },
                            {
                                name: 'time_servers',
                                type: 'ip',
                                description: 'The time server option specifies a list of RFC 868 time servers available to the client.',
                            },
                            {
                                name: 'ntp_servers',
                                type: 'ip',
                                description: 'This option specifies a list of IP addresses indicating NTP servers available to the client.',
                            },
                            {
                                name: 'hostname',
                                type: 'keyword',
                            ...
                            },
                            {
                                name: 'message',
                                type: 'text',
                                description: 'This option is used by a DHCP server to provide an error message to a DHCP client in a DHCPNAK message in the event of a failure. A client may use this option in a DHCPDECLINE message to indicate the why the client declined the offered parameters.',
                            },
                            {
                            ...
                            },
                            {
                                name: 'boot_file_name',
                                type: 'keyword',
                                description: "This option is used to identify a bootfile when the 'file' field in the DHCP header has been used for DHCP options. ",
                            },
                        ],
                    },
                ],
        ...
        fields: [
            {
                ...
                fields: [
                    ...
                    {
                        name: 'question.name',
                        description: 'The domain name being queried. If the name field contains non-printable characters (below 32 or above 126), then those characters are represented as escaped base 10 integers (\\DDD). Back slashes and quotes are escaped. Tabs, carriage returns, and line feeds are converted to \\t, \\r, and   respectively.',
                    ...
                    },
                    {
                        name: 'answers',
                        type: 'object',
                        description: 'An array containing a dictionary about each answer section returned by the server.',
                    },
                    {
                        name: 'answers_count',
                        type: 'long',
        ...
        fields: [
            {
                ...
                fields: [
                    ...
                    },
                    {
                        ...
                        type: 'boolean',
                        description: 'Whether the TLS negotiation has been successful and the session has transitioned to encrypted mode.',
                    },
                    {
                        name: 'resumed',
                        type: 'boolean',
                    ...
                    },
                    {
                        ...
                        fields: [
                            ...
                            },
                            {
                                ...
                                type: 'array',
                                description: 'List of ciphers the client is willing to use for this session. See https://www.iana.org/assignments/tls-parameters/tls-parameters.xhtml#tls-parameters-4',
                            },
                            {
                    ...
                    },
                    {
                        ...
                        fields: [
                            ...
                            },
                            {
                                ...
                                type: 'keyword',
                                description: 'The cipher suite selected by the server from the list provided by in the client hello.',
                            },
                            {
