...
const chartBase = {
    title: i18n_1.i18n.translate('xpack.apm.agentMetrics.java.nonHeapMemoryChartTitle', {
    ...
    series: {
        nonHeapMemoryUsed: {
            title: i18n_1.i18n.translate('xpack.apm.agentMetrics.java.nonHeapMemorySeriesUsed', {
                defaultMessage: 'Avg. used'
            }),
            color: eui_theme_light_json_1.default.euiColorVis0
        },
        nonHeapMemoryCommitted: {
            title: i18n_1.i18n.translate('xpack.apm.agentMetrics.java.nonHeapMemorySeriesCommitted', {
...
async function getNonHeapMemoryChart(setup, serviceName) {
