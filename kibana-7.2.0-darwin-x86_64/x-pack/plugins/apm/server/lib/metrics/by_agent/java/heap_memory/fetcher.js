...
async function fetch(setup, serviceName) {
    ...
    const aggs = {
        heapMemoryMax: { avg: { field: elasticsearch_fieldnames_1.METRIC_JAVA_HEAP_MEMORY_MAX } },
        heapMemoryCommitted: {
            avg: { field: elasticsearch_fieldnames_1.METRIC_JAVA_HEAP_MEMORY_COMMITTED }
        },
        heapMemoryUsed: { avg: { field: elasticsearch_fieldnames_1.METRIC_JAVA_HEAP_MEMORY_USED } }
    };
    const params = {
