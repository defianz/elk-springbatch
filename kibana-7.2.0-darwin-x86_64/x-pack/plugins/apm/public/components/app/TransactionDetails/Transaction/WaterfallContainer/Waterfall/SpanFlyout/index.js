...
const DiscoverSpanLink_1 = require("../../../../../../shared/Links/DiscoverLinks/DiscoverSpanLink");
...
function SpanFlyout({ span, parentTransaction, totalDuration, onClose }) {
    ...
    const codeLanguage = elastic_idx_1.idx(parentTransaction, _ => _.service.language.name);
    const dbContext = elastic_idx_1.idx(span, _ => _.span.db);
    const httpContext = elastic_idx_1.idx(span, _ => _.span.http);
    const spanLabels = span.labels;
    const labels = lodash_1.keys(spanLabels).map(key => ({
        key,
        value: lodash_1.get(spanLabels, key)
    }));
    return (react_1.default.createElement(eui_1.EuiPortal, null,
        react_1.default.createElement(ResponsiveFlyout_1.ResponsiveFlyout, { onClose: onClose, size: "m", ownFocus: true },
            ...
            react_1.default.createElement(eui_1.EuiFlyoutBody, null,
                ...
                react_1.default.createElement(eui_1.EuiTabbedContent, { tabs: [
                        ...
                        {
                            id: 'labels',
                            name: i18n_1.i18n.translate('xpack.apm.propertiesTable.tabs.labelsLabel', {
