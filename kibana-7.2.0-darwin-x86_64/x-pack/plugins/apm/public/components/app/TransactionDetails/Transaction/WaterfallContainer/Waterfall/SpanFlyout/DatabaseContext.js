...
const TruncateHeightSection_1 = require("./TruncateHeightSection");
...
const DatabaseStatement = styled_components_1.default.div `
  ...
  background: ${polished_1.tint(0.1, eui_theme_light_json_1.default.euiColorWarning)}
...
`;
const dbSyntaxLineHeight = variables_1.unit * 1.5;
function DatabaseContext({ dbContext }) {
    ...
    return (react_1.default.createElement(react_1.Fragment, null,
        ...
        react_1.default.createElement(DatabaseStatement, null,
            react_1.default.createElement(TruncateHeightSection_1.TruncateHeightSection, { previewHeight: 10 * dbSyntaxLineHeight },
                react_1.default.createElement(light_1.default, { language: 'sql', style: styles_1.xcode, customStyle: {
                        color: null,
                        background: null,
                        padding: null,
                        lineHeight: variables_1.px(dbSyntaxLineHeight),
                        whiteSpace: 'pre-wrap',
                        overflowX: 'scroll'
                    } }, dbContext.statement))),
