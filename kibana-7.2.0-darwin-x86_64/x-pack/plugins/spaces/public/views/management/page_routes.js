...
routes_1.default.when('/management/spaces/list', {
    ...
    controller($scope, $http, chrome, spacesNavState, spaceSelectorURL) {
        $scope.$$postDigest(async () => {
            ...
            react_dom_1.render(react_1.default.createElement(i18n_1.I18nContext, null,
                react_1.default.createElement(spaces_grid_1.SpacesGridPage, { spacesManager: spacesManager, spacesNavState: spacesNavState })), domNode);
...
routes_1.default.when('/management/spaces/create', {
    ...
    controller($scope, $http, chrome, spacesNavState, spaceSelectorURL) {
        $scope.$$postDigest(async () => {
            ...
            const spacesManager = new spaces_manager_1.SpacesManager($http, chrome, spaceSelectorURL);
            react_dom_1.render(react_1.default.createElement(i18n_1.I18nContext, null,
                react_1.default.createElement(edit_space_1.ManageSpacePage, { spacesManager: spacesManager, spacesNavState: spacesNavState })), domNode);
            // unmount react on controller destroy
            $scope.$on('$destroy', () => {
                if (domNode) {
                    react_dom_1.unmountComponentAtNode(domNode);
...
routes_1.default.when('/management/spaces/edit/:spaceId', {
    ...
    controller($scope, $http, $route, chrome, spacesNavState, spaceSelectorURL) {
        $scope.$$postDigest(async () => {
            const domNode = document.getElementById(reactRootNodeId);
            const { spaceId } = $route.current.params;
            const spacesManager = new spaces_manager_1.SpacesManager($http, chrome, spaceSelectorURL);
            react_dom_1.render(react_1.default.createElement(i18n_1.I18nContext, null,
                react_1.default.createElement(edit_space_1.ManageSpacePage, { spaceId: spaceId, spacesManager: spacesManager, spacesNavState: spacesNavState, setBreadcrumbs: breadcrumbs => {
