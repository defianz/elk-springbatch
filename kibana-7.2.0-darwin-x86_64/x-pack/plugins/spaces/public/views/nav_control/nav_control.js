    ...
    $scope.$parent.$watch('isVisible', function isVisibleWatcher(isVisible) {
        if (isVisible && !mounted && !pathProvider.isUnauthenticated()) {
            react_dom_1.render(react_1.default.createElement(i18n_1.I18nContext, null,
                react_1.default.createElement(nav_control_popover_1.NavControlPopover, { spacesManager: spacesManager, activeSpace: activeSpace, anchorPosition: 'rightCenter', buttonClass: spaces_global_nav_button_1.SpacesGlobalNavButton })), domNode);
            mounted = true;
        }
    });
...
chrome_header_nav_controls_1.chromeHeaderNavControlsRegistry.register(($http, chrome, Private, activeSpace) => ({
    ...
    render(el) {
        ...
        react_dom_2.default.render(react_1.default.createElement(i18n_1.I18nContext, null,
            react_1.default.createElement(nav_control_popover_1.NavControlPopover, { spacesManager: spacesManager, activeSpace: activeSpace, anchorPosition: "downLeft", buttonClass: spaces_header_nav_button_1.SpacesHeaderNavButton })), el);
    },
}));
