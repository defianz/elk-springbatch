...
class SpacesMenuUI extends react_2.Component {
    constructor() {
        ...
        this.renderManageButton = () => {
            return (react_2.default.createElement(components_1.ManageSpacesButton, { key: "manageSpacesButton", className: "spcMenu__manageButton", size: "s", onClick: this.props.onManageSpacesClick }));
        };
