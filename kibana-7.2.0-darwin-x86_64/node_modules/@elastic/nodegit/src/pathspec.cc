...
// start convert_from_v8 block
  int from_flags;
      from_flags = (int)   info[1].As<v8::Number>()->Value();
// end convert_from_v8 block
...
// start convert_to_v8 block
    if (baton->out != NULL) {
      v8::Local<v8::Array> owners = Nan::New<Array>(0);
            Nan::Set(owners, Nan::New<v8::Number>(owners->Length()), this->GetFromPersistent("ps")->ToObject());
...
// start convert_to_v8 block
    if (baton->out != NULL) {
      v8::Local<v8::Array> owners = Nan::New<Array>(0);
            Nan::Set(owners, Nan::New<v8::Number>(owners->Length()), this->GetFromPersistent("ps")->ToObject());
            Nan::Set(owners, Nan::New<v8::Number>(owners->Length()), this->GetFromPersistent("index")->ToObject());
             to = GitPathspecMatchList::New(
        baton->out,
        true
          , owners
...
// start convert_to_v8 block
    if (baton->out != NULL) {
      v8::Local<v8::Array> owners = Nan::New<Array>(0);
            Nan::Set(owners, Nan::New<v8::Number>(owners->Length()), this->GetFromPersistent("ps")->ToObject());
            Nan::Set(owners, Nan::New<v8::Number>(owners->Length()), this->GetFromPersistent("tree")->ToObject());
             to = GitPathspecMatchList::New(
        baton->out,
        true
          , owners
...
// start convert_from_v8 block
  int from_flags;
      from_flags = (int)   info[0].As<v8::Number>()->Value();
// end convert_from_v8 block
// start convert_from_v8 block
