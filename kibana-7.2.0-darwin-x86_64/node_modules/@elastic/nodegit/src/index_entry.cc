  ...
  Nan::Set(target, Nan::New("IndexEntry").ToLocalChecked(), _constructor_template);
    ...
    NAN_SETTER(GitIndexEntry::SetDev) {
      GitIndexEntry *wrapper = Nan::ObjectWrap::Unwrap<GitIndexEntry>(info.This());
         ...
         if (value->IsNumber()) {
          wrapper->GetValue()->dev = (int) Nan::To<int32_t>(value).FromJust();
        }
     }
    ...
    NAN_SETTER(GitIndexEntry::SetIno) {
      GitIndexEntry *wrapper = Nan::ObjectWrap::Unwrap<GitIndexEntry>(info.This());
         ...
         if (value->IsNumber()) {
          wrapper->GetValue()->ino = (int) Nan::To<int32_t>(value).FromJust();
        }
     }
    ...
    NAN_SETTER(GitIndexEntry::SetMode) {
      GitIndexEntry *wrapper = Nan::ObjectWrap::Unwrap<GitIndexEntry>(info.This());
         ...
         if (value->IsNumber()) {
          wrapper->GetValue()->mode = (int) Nan::To<int32_t>(value).FromJust();
        }
     }
    ...
    NAN_SETTER(GitIndexEntry::SetUid) {
      GitIndexEntry *wrapper = Nan::ObjectWrap::Unwrap<GitIndexEntry>(info.This());
         ...
         if (value->IsNumber()) {
          wrapper->GetValue()->uid = (int) Nan::To<int32_t>(value).FromJust();
        }
     }
    ...
    NAN_SETTER(GitIndexEntry::SetGid) {
      GitIndexEntry *wrapper = Nan::ObjectWrap::Unwrap<GitIndexEntry>(info.This());
         ...
         if (value->IsNumber()) {
          wrapper->GetValue()->gid = (int) Nan::To<int32_t>(value).FromJust();
        }
     }
    ...
    NAN_SETTER(GitIndexEntry::SetFileSize) {
      GitIndexEntry *wrapper = Nan::ObjectWrap::Unwrap<GitIndexEntry>(info.This());
         ...
         if (value->IsNumber()) {
          wrapper->GetValue()->file_size = (int) Nan::To<int32_t>(value).FromJust();
        }
     }
    ...
    NAN_SETTER(GitIndexEntry::SetFlags) {
      GitIndexEntry *wrapper = Nan::ObjectWrap::Unwrap<GitIndexEntry>(info.This());
         ...
         if (value->IsNumber()) {
          wrapper->GetValue()->flags = (int) Nan::To<int32_t>(value).FromJust();
        }
     }
    ...
    NAN_SETTER(GitIndexEntry::SetFlagsExtended) {
      GitIndexEntry *wrapper = Nan::ObjectWrap::Unwrap<GitIndexEntry>(info.This());
         ...
         if (value->IsNumber()) {
          wrapper->GetValue()->flags_extended = (int) Nan::To<int32_t>(value).FromJust();
        }
     }
