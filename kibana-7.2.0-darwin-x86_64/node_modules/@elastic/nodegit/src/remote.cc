    ...
    tpl->SetClassName(Nan::New("Remote").ToLocalChecked());
           ...
           Nan::SetMethod(tpl, "addFetch", AddFetch);
            ...
            Nan::SetPrototypeMethod(tpl, "connected", Connected);
             ...
             Nan::SetMethod(tpl, "createInitOptions", CreateInitOptions);
  ...
  // end convert_to_v8 block
    ...
    if (baton->error) {
      ...
      if (baton->error->message) {
        ...
        err = Nan::Error("Method createDetached has thrown an error.")->ToObject();
      }
      err->Set(Nan::New("errno").ToLocalChecked(), Nan::New(baton->error_code));
      err->Set(Nan::New("errorFunction").ToLocalChecked(), Nan::New("Remote.createDetached").ToLocalChecked());
      v8::Local<v8::Value> argv[1] = {
        err
      };
      callback->Call(1, argv, async_resource);
      ...
      if (!callbackFired) {
        v8::Local<v8::Object> err = Nan::Error("Method createDetached has thrown an error.")->ToObject();
        err->Set(Nan::New("errno").ToLocalChecked(), Nan::New(baton->error_code));
        err->Set(Nan::New("errorFunction").ToLocalChecked(), Nan::New("Remote.createDetached").ToLocalChecked());
        v8::Local<v8::Value> argv[1] = {
          err
 ...
 * @param RemoteCreateOptions opts
   * @param Number version
     * @return Number  result    */
NAN_METHOD(GitRemote::CreateInitOptions) {
  Nan::EscapableHandleScope scope;

  if (info.Length() == 0 || !info[0]->IsObject()) {
    return Nan::ThrowError("RemoteCreateOptions opts is required.");
  }
...
// start convert_from_v8 block
  git_remote_create_options * from_opts = NULL;
from_opts = Nan::ObjectWrap::Unwrap<GitRemoteCreateOptions>(info[0]->ToObject())->GetValue();
// end convert_from_v8 block
// start convert_from_v8 block
...
// end convert_from_v8 block
 ...
 int result =     git_remote_create_init_options(
          from_opts
,          from_version
    );
...
// start convert_from_v8 block
  const git_remote_create_options * from_opts = NULL;
    if (info[1]->IsObject()) {
from_opts = Nan::ObjectWrap::Unwrap<GitRemoteCreateOptions>(info[1]->ToObject())->GetValue();
  }
  else {
    from_opts = 0;
  }
  ...
  // end convert_to_v8 block
    ...
    if (baton->error) {
      ...
      if (baton->error->message) {
        ...
        err = Nan::Error("Method createWithOpts has thrown an error.")->ToObject();
      }
      err->Set(Nan::New("errno").ToLocalChecked(), Nan::New(baton->error_code));
      err->Set(Nan::New("errorFunction").ToLocalChecked(), Nan::New("Remote.createWithOpts").ToLocalChecked());
      v8::Local<v8::Value> argv[1] = {
        err
      };
      callback->Call(1, argv, async_resource);
      ...
      if (!callbackFired) {
        v8::Local<v8::Object> err = Nan::Error("Method createWithOpts has thrown an error.")->ToObject();
        err->Set(Nan::New("errno").ToLocalChecked(), Nan::New(baton->error_code));
        err->Set(Nan::New("errorFunction").ToLocalChecked(), Nan::New("Remote.createWithOpts").ToLocalChecked());
        v8::Local<v8::Value> argv[1] = {
          err
