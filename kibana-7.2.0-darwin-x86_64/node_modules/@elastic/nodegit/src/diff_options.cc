 ...
 ,               baton->new_path == NULL
    ...
    NAN_SETTER(GitDiffOptions::SetContextLines) {
      GitDiffOptions *wrapper = Nan::ObjectWrap::Unwrap<GitDiffOptions>(info.This());
         ...
         if (value->IsNumber()) {
          wrapper->GetValue()->context_lines = (int) Nan::To<int32_t>(value).FromJust();
        }
     }
    ...
    NAN_SETTER(GitDiffOptions::SetInterhunkLines) {
      GitDiffOptions *wrapper = Nan::ObjectWrap::Unwrap<GitDiffOptions>(info.This());
         ...
         if (value->IsNumber()) {
          wrapper->GetValue()->interhunk_lines = (int) Nan::To<int32_t>(value).FromJust();
        }
     }
    ...
    NAN_SETTER(GitDiffOptions::SetIdAbbrev) {
      GitDiffOptions *wrapper = Nan::ObjectWrap::Unwrap<GitDiffOptions>(info.This());
         ...
         if (value->IsNumber()) {
          wrapper->GetValue()->id_abbrev = (int) Nan::To<int32_t>(value).FromJust();
        }
     }
