...
// start convert_to_v8 block
    if (baton->iterator_out != NULL) {
      v8::Local<v8::Array> owners = Nan::New<Array>(0);
            Nan::Set(owners, Nan::New<v8::Number>(owners->Length()), this->GetFromPersistent("index")->ToObject());
             to = GitIndexConflictIterator::New(
        baton->iterator_out,
        true
          , owners
       );
  ...
  // end convert_to_v8 block
    ...
    if (baton->error) {
      ...
      err->Set(Nan::New("errorFunction").ToLocalChecked(), Nan::New("IndexConflictIterator.create").ToLocalChecked());
...
// start convert_to_v8 block
  ...
  // end convert_to_v8 block
          Nan::Set(toReturn, Nan::New("ancestor_out").ToLocalChecked(), to);
// start convert_to_v8 block
    if (our_out != NULL) {
      v8::Local<v8::Array> owners = Nan::New<Array>(0);
         Nan::Set(owners, owners->Length(), info.This());
  ...
  // end convert_to_v8 block
          Nan::Set(toReturn, Nan::New("our_out").ToLocalChecked(), to);
// start convert_to_v8 block
    if (their_out != NULL) {
      v8::Local<v8::Array> owners = Nan::New<Array>(0);
         Nan::Set(owners, owners->Length(), info.This());
  ...
  // end convert_to_v8 block
          Nan::Set(toReturn, Nan::New("their_out").ToLocalChecked(), to);
