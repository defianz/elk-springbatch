...
// start convert_to_v8 block
    if (baton->out != NULL) {
      v8::Local<v8::Array> owners = Nan::New<Array>(0);
            Nan::Set(owners, Nan::New<v8::Number>(owners->Length()), this->GetFromPersistent("reference")->ToObject());
             to = GitBlame::New(
        baton->out,
        true
          , owners
...
// start convert_from_v8 block
  int from_index;
      from_index = (int)   info[0].As<v8::Number>()->Value();
// end convert_from_v8 block
...
NAN_METHOD(GitBlame::GetHunkCount) {
 ...
 int result =     git_blame_get_hunk_count(
          Nan::ObjectWrap::Unwrap<GitBlame>(info.This())->GetValue()
    );
